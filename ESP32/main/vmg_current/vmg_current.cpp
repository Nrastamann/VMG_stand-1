...
void
vmg_current_sensor::calibrate(uint8_t instance)
{
...
void
vmg_current_sensor::update_calibration()
{
...
void
vmg_current_sensor::add_driver(vmg_current_driver* driver)
{
